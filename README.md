...
![alt text](reports/assets/grid_scores.png "RESNET50 TRAINED ON 100% OF THE ORIGINAL DATASET, FINE-TUNED, WITH DATA AUGMENTATION AND L2 REGULARIZATION; MAX F2-SCORE PER LABEL")
...
![alt text](reports/assets/thresholds.png "RESNET50 TRAINED ON 100% OF THE ORIGINAL DATASET, FINE-TUNED, WITH DATA AUGMENTATION AND L2 REGULARIZATION; MAX F2-SCORE PER LABEL")
